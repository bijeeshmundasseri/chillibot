...
async def _(event):
    ...
    if input_str == "balaji":
        ...
        animation_chars = [
            ...
            "`Fork Deploying...`\n\n@UniBorg ( `Custom Built By` @dieaena ) \n`Verified Account:` ☑️\n`Official Website:` https://@selectivegramophone bsdk\n\n`Python` `Loading...`\n[GCC 7.3.0]\n`Telethon` `Loading...`\n\n`Custom Built Fork:` `Loading...`",
            "`Fork Deployed...`\n\n@UniBorg ( `Custom Built By` @dieaena ) \n`Verified Account:` ✅\n`Official Website:` https://@trendingjobe bsdk\n\n`Python` 3.6.8 (default, Jan 29 2019, 19:35:16)\n[GCC 7.3.0]\n`Telethon` 1.8.0\n\n`Custom Built Fork:` https://github.com/dieana/userbot"
        ]
